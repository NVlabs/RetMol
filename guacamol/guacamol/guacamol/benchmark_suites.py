...
#
# Source:
# https://github.com/BenevolentAI/guacamol/blob/master/guacamol/benchmark_suites.py
#
...
from guacamol.guacamol.distribution_learning_benchmark import DistributionLearningBenchmark, ValidityBenchmark, \
    UniquenessBenchmark
from guacamol.guacamol.goal_directed_benchmark import GoalDirectedBenchmark
from guacamol.guacamol.scoring_function import ArithmeticMeanScoringFunction
from guacamol.guacamol.standard_benchmarks import hard_cobimetinib, similarity, logP_benchmark, cns_mpo, \
