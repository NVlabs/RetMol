...
# https://github.com/BenevolentAI/guacamol/blob/master/guacamol/utils/sampling_helper.py
#
...
from guacamol.guacamol.utils.chemistry import is_valid, canonicalize
