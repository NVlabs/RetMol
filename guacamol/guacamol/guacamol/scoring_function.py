...
# https://github.com/BenevolentAI/guacamol/blob/master/guacamol/scoring_function.py
#
...
from guacamol.guacamol.score_modifier import ScoreModifier, LinearModifier
from guacamol.guacamol.utils.math import geometric_mean
